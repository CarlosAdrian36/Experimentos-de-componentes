<template>
          ...
          <li>
            ...
            >
              <span class="w-6 flex justify-center"
                ><font-awesome-icon class="fa-light" icon="user-group"
              /></span>
              <span class="is-drawer-close:hidden">Miembros</span>
            </button>
          </li>
  ...
  asjhdkajs kasjhdka' adnbasksd asjkdha'sabkjdfs'
  <i class="fa-lighthgfd fa-user-group"></i>
  adsd
