    ...
    <div class="w-full max-w-sm">
      <label class="relative block">
        <input
          type="text"
          placeholder=" "
          class="peer w-full h-12 px-3 leading-5 bg-transparent border border-base-300 rounded-md focus:border-primary focus:ring-1 focus:ring-primary/40 focus:outline-none transition"
        />

        <span
          class="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/60 bg-base-100 px-1 leading-none transition-all pointer-events-none peer-focus:top-0 peer-focus:text-xs peer-focus:text-primary peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:text-xs"
        >
